...
class BibPoster(tasker.DootTasker, MastodonMixin, BibLoadSaveMixin, BibPathCleanMixin, BibFieldCleanMixin):
    """
...
class ImagePoster(tasker.DootTasker, MastodonMixin):
    """
