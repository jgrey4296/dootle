...
# If false, manual toctree entry (eg: _docs/autoapi/dootle/index) needs to be added:
...
extlinks = {
    # Add ':issue:' role:
    "issue": ("https://github.com/jgrey4296/dootle/issues/%s", "issue %s"),
}
